...
### `XGBoost.ipynb` — Building the Prediction Model
...
- **Product importance** has a measurable effect — High importance products show a better on-time rate
- The `ID` column has zero predictive value and is excluded from modeling
